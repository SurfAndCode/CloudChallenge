...
This was another straightforward step. There isn’t much to add here — but if you’re new to front-end development, I highly recommend [freeCodeCamp](https://www.freecodecamp.org/) and [The Odin Project](https://www.theodinproject.com/).
...
[Reference:](https://learn.microsoft.com/en-us/azure/cdn/cdn-create-a-storage-account-with-cdn)
...
If you haven’t read [Eloquent JavaScript](https://eloquentjavascript.net/ )
...
Steps 9 and 10 gave me a few headaches. I spent quite a bit of time going through [the official Azure Functions documentation](https://docs.microsoft.com/en-us/azure/azure-functions/functions-bindings-http-webhook).
